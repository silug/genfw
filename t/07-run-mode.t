...
{
    like($script->{stdout}, qr/\A#!\/usr\/sbin\/iptables-restore\n/, 'first line is a shebang for iptables-restore');
    like($script->{stdout}, qr/^# Generated by genfw \d/m, 'header names genfw and the version');
    like($script->{stdout}, qr/^# Load with "iptables-restore < this-file"/m, 'header says how to load the file');
